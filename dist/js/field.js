...
/* harmony import */ var _mixins_FieldValues__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../mixins/FieldValues */ "./resources/js/mixins/FieldValues.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [_mixins_FieldValues__WEBPACK_IMPORTED_MODULE_0__["default"]],
...
/* harmony import */ var _mixins_FieldValues__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../mixins/FieldValues */ "./resources/js/mixins/FieldValues.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [laravel_nova__WEBPACK_IMPORTED_MODULE_2__["FormField"], laravel_nova__WEBPACK_IMPORTED_MODULE_2__["HandlesValidationErrors"], _mixins_FieldValues__WEBPACK_IMPORTED_MODULE_3__["default"]],
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this.setValueFromField();

                _context.next = 3;
                return _this.setInitialOptions();
      ...
      if (query !== '') {
        ...
        this.ajaxTimeout = setTimeout(function () {
          Nova.request().get('/nova-vendor/ajax-multiselect-nova-field/ajax', {
            params: {
              'class': _this3.field.modelClass,
              'label': _this3.label,
              'limit': _this3.field.maxOptions,
              'query': query
            }
              ...
              ? _c("div", [
                  !_vm.show
                    ? _c(
                        "div",
                        {
                          staticClass: "my-2 ajax-multiselect__show-more",
                          on: {
          ...
          [
            _c("multiselect", {
              attrs: {
                ...
                placeholder: _vm.field.placeholder || "Select option",
                "close-on-select": false,
                loading: _vm.isLoading,
                multiple: true,
                taggable: true
              },
              on: { "search-change": _vm.getOptions, tag: _vm.addTag },
              model: {
                value: _vm.value,
                callback: function($$v) {
                  _vm.value = $$v
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("span", [_vm._v(_vm._s(_vm.value.length || "—"))])
}
var staticRenderFns = []
render._withStripped = true
...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-ajax-multiselect', __webpack_require__(/*! ./components/IndexField */ "./resources/js/components/IndexField.vue")["default"]);
  Vue.component('detail-ajax-multiselect', __webpack_require__(/*! ./components/DetailField */ "./resources/js/components/DetailField.vue")["default"]);
  Vue.component('form-ajax-multiselect', __webpack_require__(/*! ./components/FormField */ "./resources/js/components/FormField.vue")["default"]);
});

/***/ }),

/***/ "./resources/js/mixins/FieldValues.js":
/*!********************************************!*\
  !*** ./resources/js/mixins/FieldValues.js ***!
  \********************************************/
/*! exports provided: default */
...
__webpack_require__(/*! /home/seva/Desktop/work/vue-multiselect/resources/js/field.js */"./resources/js/field.js");
module.exports = __webpack_require__(/*! /home/seva/Desktop/work/vue-multiselect/resources/sass/field.scss */"./resources/sass/field.scss");
